...
int main(void)
{
	...
	unAlumno.nacimiento.dia = 23;
	unAlumno.nacimiento.mes = 05;
	unAlumno.nacimiento.anio = 2001;

	puntAlumno = &unAlumno;
        printf ("\nEl nombre del alumno es: %s y nació en %i, con promedio %f \n", unAlumno.nombre, unAlumno.nacimiento.anio, unAlumno.promedio);

        puntAlumno->promedio = 10;
        printf ("\nEl nombre del alumno es: %s y nació en %i, con promedio %f \n", puntAlumno->nombre, puntAlumno->nacimiento.anio, unAlumno.promedio);
