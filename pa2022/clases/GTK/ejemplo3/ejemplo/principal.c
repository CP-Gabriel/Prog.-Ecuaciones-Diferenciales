...
int main(int argc, char *argv[])
{
  ...
  base.lbStatus = gtk_label_new("Estatus de Push/Pop");
  ...
  gtk_box_pack_start_defaults(GTK_BOX(vbox), base.lbStatus);
...
void pushTexto(GtkWidget *boton, gpointer estructura)
{
  ...
  gtk_label_set_text(GTK_LABEL(pt->lbStatus), mensaje);
...
{
  ref *pt = (ref *)estructura;
  gtk_label_set_text(GTK_LABEL(pt->lbStatus), "Cerrando la aplicación...");
