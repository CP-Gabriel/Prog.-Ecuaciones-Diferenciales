...
{
	GtkWidget *window, *table, *resultado, *botonAC, *botonMM, *botonPor, *botonDiv, *boton7, *boton8, *boton9, *botonX;
	...
	gtk_signal_connect(GTK_OBJECT(boton7),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton8),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton9),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton4),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
 	gtk_signal_connect(GTK_OBJECT(boton5),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton6),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton1),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton2),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton3),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_signal_connect(GTK_OBJECT(boton0),"clicked",GTK_SIGNAL_FUNC(ponNum), resultado);
	gtk_table_attach(GTK_TABLE(table), resultado, 0, 4, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
	gtk_table_attach(GTK_TABLE(table), botonAC, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
	gtk_table_attach(GTK_TABLE(table), botonMM, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
	gtk_table_attach(GTK_TABLE(table), botonPor, 2, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
	gtk_table_attach(GTK_TABLE(table), botonDiv, 3, 4, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table), botonMenos, 3, 4, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table), botonMas, 3, 4, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table), botonEq, 3, 4, 5, 6, GTK_FILL, GTK_FILL, 0, 0);
