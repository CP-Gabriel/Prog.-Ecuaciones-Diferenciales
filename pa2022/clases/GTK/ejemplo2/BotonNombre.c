/**
* @file BotonNombre.c
* @brief Este es un ejemplo para entender como un botón cambia el nombre de un label.
...
/**
* @brief Esta función pesca el cierre de ventana (destroy).
...
/**
* @brief Esta función pesca el el evento que se realiza en el click del botón y cambia el nombre del labal.
