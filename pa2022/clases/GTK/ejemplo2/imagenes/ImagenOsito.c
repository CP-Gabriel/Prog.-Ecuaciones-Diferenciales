/**
* @file ImagenOsito.c
* @brief Este es un ejemplo para entender como abrir una imagen en un objeto.
...
/**
* @brief Esta función pesca el el evento que se realiza en el click del botón y cambia la imagen en el box.
* @author/autor Guillermo Gómez
